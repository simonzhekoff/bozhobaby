<?php namespace Buzz\Oksireserv\Tests\Facades;
...
class ReservationsFacadeTest extends PluginTestCase
{
    ...
    public function testStoreReservationDaysOff()
    {
        ...
        foreach (['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $dayOfWeek) {
            ...
            $this->assertEquals('buzz.oksireserv::lang.errors.days_off', $exceptionTest->getMessage());
        }
    ...
    {
        $default = Config::get('buzz.oksireserv::config.protection_time', '-30 seconds');
        Config::set('buzz.oksireserv::config.protection_time', '0 seconds');
        $model = $this->getModel();
        ...
        Config::set('buzz.oksireserv::config.protection_time', $default);
    }
    ...
    public function testStoreReservation()
    {
        ...
        // check status
        $defaultStatusIdent = Config::get('buzz.oksireserv::config.statuses.received', 'received');
