...
class Reservations extends Controller
{
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Buzz.Oksireserv', 'reservations', $action);
    }
    ...
    {
        $this->addJs('/plugins/buzz/oksireserv/assets/js/bulk-actions.js');
    ...
    public function index_onBulkAction()
    {
        if (($bulkAction = post('action')) && ($checkedIds = post('checked')) && is_array($checkedIds) && count($checkedIds)) {
            ...
            $msg = Lang::get('buzz.oksireserv::lang.reservations.change_status_success');
            Flash::success($msg);
        }
